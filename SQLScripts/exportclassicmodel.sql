...
-- Dumping data for table classicmodels.customers: ~134 rows (approximately)
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`customerNumber`, `customerName`, `contactLastName`, `contactFirstName`, `phone`, `addressLine1`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `salesRepEmployeeNumber`, `creditLimit`) VALUES
	(1, 'sssh sfsfsfsfsfs', 'g', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	...
	(487, 'Signal Collectibles Ltd.', 'Taylor', 'Sue', '123123123', 'New address for customer', NULL, 'Brisbane', 'CA', '94217', 'USA', 1165, 60300.00),
	(488, 'ABCD', 'XYZ', 'IOP', '123456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	...
	(497, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(498, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(499, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(500, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(501, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(502, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(503, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(504, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(505, 'dgdg', 'XfgfgYZ', 'fgf', '12344456', NULL, NULL, 'NYC', 'NY', NULL, NULL, NULL, NULL),
	(5000, 'haseeb', 'ddg', 'sgg', '56656', 'sdgsdgsdg', 'gsdg', 'nyc', 'NY', '434634', 'USA', 1102, 100.00);
/*!40000 ALTER TABLE `customers` ENABLE KEYS */;

-- Dumping structure for table classicmodels.department
...
-- Dumping data for table classicmodels.department: ~0 rows (approximately)
...
-- Dumping data for table classicmodels.employees: ~26 rows (approximately)
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
	(0, 'hn', 'myname', '02145', 'abcdef@gmail.com', '7', 1002, 'Developer'),
	(26, 'Mick', 'JDK', NULL, 'mk@gmai.com', '1', 1102, NULL),
	(1002, 'Larson', 'abcd', 'x5800', 'abcd@gmail.com', '1', 1002, 'President'),
	(1056, 'Phan', 'Mary', 'x4611', 'xyz01@prscholas.org', '1', 1002, 'VP Sales'),
	(1076, 'Firrelli', 'Jeff', 'x9273', 'abc@perscholas.org', '1', 1002, 'VP Marketing'),
	(1088, 'Patterson', 'William', 'x4871', 'abcd@gmail.com', '6', 1056, 'Sales Manager (APAC)'),
	...
	(1703, 'Tim', 'Tom', '02145', 'abcdef@gmail.com', '7', 1002, 'Developer'),
	(1704, 'abc', 'abc', 'abc', 'baaa@gf.com', '7', 1076, NULL);
...
-- Dumping data for table classicmodels.offices: ~22 rows (approximately)
/*!40000 ALTER TABLE `offices` DISABLE KEYS */;
INSERT INTO `offices` (`officeCode`, `city`, `phone`, `addressLine1`, `addressLine2`, `state`, `country`, `postalCode`, `territory`, `createdate`, `Createtime`) VALUES
	('', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	...
	('2200', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('3', 'NYC', '+1 212 555 3000', '523 East 53rd Street', 'apt. 5A', 'NY', 'USA', '10022', 'NA', NULL, NULL),
	('3000', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('3001', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('3002', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('30020', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('30021', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300212', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300213', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300214', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300215', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300216', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300217', 'NYC', '95874545', 'my address demo', 'my second address', 'NY', 'USA', '11111', 'USA', NULL, NULL),
	('300218', 'PHILi', '2145', 'my addressl', NULL, NULL, 'USA', '11111', 'USA', NULL, NULL),
	('3003', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('3004', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', '94080', 'NA', NULL, NULL),
	('4', 'Paris', '+33 14 723 4404', '43 Rue Jouffroy D\'abbans', NULL, NULL, 'France', '75017', 'EMEA', NULL, NULL),
	('40000', 'PHILi', '2145', 'my addressl', NULL, NULL, 'USA', '11111', 'USA', '2021-03-23', NULL),
	('40001', 'NewYork', '2563', '12st street', NULL, NULL, 'USA', '75700', 'NYC', '2021-05-25', NULL),
	('40002', 'NewYork', '2563', '12st street', NULL, NULL, 'USA', '75700', 'NYC', '2021-05-25', '13:57:07'),
...
INSERT INTO `payments` (`customerNumber`, `checkNumber`, `paymentDate`, `amount`, `status`) VALUES
	(103, 'HQ336336', '2004-10-19', 6066.78, 'paid'),
	(103, 'JM555205', '2003-06-05', 14571.44, 'paid'),
	(103, 'OM314933', '2004-12-18', 1676.14, 'paid'),
	(112, 'BO864823', '2004-12-17', 14191.12, 'pending'),
	(112, 'HQ55022', '2003-06-06', 32641.98, 'pending'),
	(112, 'ND748579', '2004-08-20', 33347.88, 'pending'),
	(114, 'GG31455', '2003-05-20', 45864.03, 'paid'),
	(114, 'MA765515', '2004-12-15', 82261.22, 'paid'),
	(114, 'NP603840', '2003-05-31', 7565.08, 'paid'),
	(114, 'NR27552', '2004-03-10', 44894.74, 'paid'),
	(119, 'DB933704', '2004-11-14', 19501.82, 'paid'),
	(119, 'LN373447', '2004-08-08', 47924.19, 'paid'),
	(119, 'NG94694', '2005-02-22', 49523.67, 'paid'),
	(121, 'DB889831', '2003-02-16', 50218.95, 'paid'),
	(121, 'FD317790', '2003-10-28', 1491.38, 'paid'),
	(121, 'KI831359', '2004-11-04', 17876.32, 'paid'),
	(121, 'MA302151', '2004-11-28', 34638.14, 'paid'),
	(124, 'AE215433', '2005-03-05', 101244.59, 'pending'),
	(124, 'BG255406', '2004-08-28', 85410.87, 'pending'),
	(124, 'CQ287967', '2003-04-11', 11044.30, 'pending'),
	(124, 'ET64396', '2005-04-16', 83598.04, 'pending'),
	(124, 'HI366474', '2004-12-27', 47142.70, 'pending'),
	(124, 'HR86578', '2004-11-02', 55639.66, 'pending'),
	(124, 'KI131716', '2003-08-15', 111654.40, 'pending'),
	(124, 'LF217299', '2004-03-26', 43369.30, 'pending'),
	(124, 'NT141748', '2003-11-25', 45084.38, 'pending'),
	(128, 'DI925118', '2003-01-28', 10549.01, 'paid'),
	(128, 'FA465482', '2003-10-18', 24101.81, 'paid'),
	(128, 'FH668230', '2004-03-24', 33820.62, 'paid'),
	(128, 'IP383901', '2004-11-18', 7466.32, 'paid'),
	(129, 'DM826140', '2004-12-08', 26248.78, 'pending'),
	(129, 'ID449593', '2003-12-11', 23923.93, 'pending'),
	(129, 'PI42991', '2003-04-09', 16537.85, 'pending'),
	(131, 'CL442705', '2003-03-12', 22292.62, 'pending'),
	(131, 'MA724562', '2004-12-02', 50025.35, 'pending'),
	(131, 'NB445135', '2004-09-11', 35321.97, 'pending'),
	(141, 'AU364101', '2003-07-19', 36251.03, 'paid'),
	(141, 'DB583216', '2004-11-01', 36140.38, 'paid'),
	(141, 'DL460618', '2005-05-19', 46895.48, 'paid'),
	(141, 'HJ32686', '2004-01-30', 59830.55, 'paid'),
	(141, 'ID10962', '2004-12-31', 116208.40, 'paid'),
	(141, 'IN446258', '2005-03-25', 65071.26, 'paid'),
	(141, 'JE105477', '2005-03-18', 120166.58, 'paid'),
	(141, 'JN355280', '2003-10-26', 49539.37, 'paid'),
	(141, 'JN722010', '2003-02-25', 40206.20, 'paid'),
	(141, 'KT52578', '2003-12-09', 63843.55, 'paid'),
	(141, 'MC46946', '2004-07-09', 35420.74, 'paid'),
	(141, 'MF629602', '2004-08-16', 20009.53, 'paid'),
	(141, 'NU627706', '2004-05-17', 26155.91, 'paid'),
	(144, 'IR846303', '2004-12-12', 36005.71, 'paid'),
	(144, 'LA685678', '2003-04-09', 7674.94, 'paid'),
	(145, 'CN328545', '2004-07-03', 4710.73, 'paid'),
	(145, 'ED39322', '2004-04-26', 28211.70, 'paid'),
	(145, 'HR182688', '2004-12-01', 20564.86, 'paid'),
	(145, 'JJ246391', '2003-02-20', 53959.21, 'paid'),
	(146, 'FP549817', '2004-03-18', 40978.53, 'paid'),
	(146, 'FU793410', '2004-01-16', 49614.72, 'paid'),
	(146, 'LJ160635', '2003-12-10', 39712.10, 'paid'),
	(148, 'BI507030', '2003-04-22', 44380.15, 'paid'),
	(148, 'DD635282', '2004-08-11', 2611.84, 'paid'),
	(148, 'KM172879', '2003-12-26', 105743.00, 'paid'),
	(148, 'ME497970', '2005-03-27', 3516.04, 'paid'),
	(151, 'BF686658', '2003-12-22', 58793.53, 'pending'),
	(151, 'GB852215', '2004-07-26', 20314.44, 'pending'),
	(151, 'IP568906', '2003-06-18', 58841.35, 'pending'),
	(151, 'KI884577', '2004-12-14', 39964.63, 'pending'),
	(157, 'HI618861', '2004-11-19', 35152.12, 'pending'),
	(157, 'NN711988', '2004-09-07', 63357.13, 'pending'),
	(161, 'BR352384', '2004-11-14', 2434.25, 'pending'),
	(161, 'BR478494', '2003-11-18', 50743.65, 'pending'),
	(161, 'KG644125', '2005-02-02', 12692.19, 'pending'),
	(161, 'NI908214', '2003-08-05', 38675.13, 'pending'),
	(166, 'BQ327613', '2004-09-16', 38785.48, 'paid'),
	(166, 'DC979307', '2004-07-07', 44160.92, 'paid'),
	(166, 'LA318629', '2004-02-28', 22474.17, 'paid'),
	(167, 'ED743615', '2004-09-19', 12538.01, 'paid'),
	(167, 'GN228846', '2003-12-03', 85024.46, 'paid'),
	(171, 'GB878038', '2004-03-15', 18997.89, 'paid'),
	(171, 'IL104425', '2003-11-22', 42783.81, 'paid'),
	(172, 'AD832091', '2004-09-09', 1960.80, 'paid'),
	(172, 'CE51751', '2004-12-04', 51209.58, 'paid'),
	(172, 'EH208589', '2003-04-20', 33383.14, 'paid'),
	(173, 'GP545698', '2004-05-13', 11843.45, 'pending'),
	(173, 'IG462397', '2004-03-29', 20355.24, 'pending'),
	(175, 'CITI3434344', '2005-05-19', 28500.78, 'pending'),
	(175, 'IO448913', '2003-11-19', 24879.08, 'pending'),
	(175, 'PI15215', '2004-07-10', 42044.77, 'pending'),
	(177, 'AU750837', '2004-04-17', 15183.63, 'pending'),
	(177, 'CI381435', '2004-01-19', 47177.59, 'pending'),
	(181, 'CM564612', '2004-04-25', 22602.36, 'pending'),
	(181, 'GQ132144', '2003-01-30', 5494.78, 'pending'),
	(181, 'OH367219', '2004-11-16', 44400.50, 'pending'),
	(186, 'AE192287', '2005-03-10', 23602.90, 'paid'),
	(186, 'AK412714', '2003-10-27', 37602.48, 'paid'),
	(186, 'KA602407', '2004-10-21', 34341.08, 'paid'),
	(187, 'AM968797', '2004-11-03', 52825.29, 'paid'),
	(187, 'BQ39062', '2004-12-08', 47159.11, 'paid'),
	(187, 'KL124726', '2003-03-27', 48425.69, 'paid'),
	(189, 'BO711618', '2004-10-03', 17359.53, 'paid'),
	(189, 'NM916675', '2004-03-01', 32538.74, 'paid'),
	(198, 'FI192930', '2004-12-06', 9658.74, 'pending'),
	(198, 'HQ920205', '2003-07-06', 6036.96, 'pending'),
	(198, 'IS946883', '2004-09-21', 5858.56, 'pending'),
	(201, 'DP677013', '2003-10-20', 23908.24, 'paid'),
	(201, 'OO846801', '2004-06-15', 37258.94, 'paid'),
	(202, 'HI358554', '2003-12-18', 36527.61, 'paid'),
	(202, 'IQ627690', '2004-11-08', 33594.58, 'paid'),
	(204, 'GC697638', '2004-08-13', 51152.86, 'pending'),
	(204, 'IS150005', '2004-09-24', 4424.40, 'pending'),
	(205, 'GL756480', '2003-12-04', 3879.96, 'pending'),
	(205, 'LL562733', '2003-09-05', 50342.74, 'pending'),
	(205, 'NM739638', '2005-02-06', 39580.60, 'pending'),
	(209, 'BOAF82044', '2005-05-03', 35157.75, 'paid'),
	(209, 'ED520529', '2004-06-21', 4632.31, 'paid'),
	(209, 'PH785937', '2004-05-04', 36069.26, 'paid'),
	(211, 'BJ535230', '2003-12-09', 45480.79, 'paid'),
	(216, 'BG407567', '2003-05-09', 3101.40, 'paid'),
	(216, 'ML780814', '2004-12-06', 24945.21, 'paid'),
	(216, 'MM342086', '2003-12-14', 40473.86, 'paid'),
	(219, 'BN17870', '2005-03-02', 3452.75, 'pending'),
	(219, 'BR941480', '2003-10-18', 4465.85, 'pending'),
	(227, 'MQ413968', '2003-10-31', 36164.46, 'paid'),
	(227, 'NU21326', '2004-11-02', 53745.34, 'paid'),
	(233, 'BOFA23232', '2005-05-20', 29070.38, 'paid'),
	(233, 'II180006', '2004-07-01', 22997.45, 'paid'),
	(233, 'JG981190', '2003-11-18', 16909.84, 'paid'),
	(239, 'NQ865547', '2004-03-15', 80375.24, 'pending'),
	(240, 'IF245157', '2004-11-16', 46788.14, 'paid'),
	(240, 'JO719695', '2004-03-28', 24995.61, 'paid'),
	(242, 'AF40894', '2003-11-22', 33818.34, 'paid'),
	(242, 'HR224331', '2005-06-03', 12432.32, 'paid'),
	(242, 'KI744716', '2003-07-21', 14232.70, 'paid'),
	(249, 'IJ399820', '2004-09-19', 33924.24, 'paid'),
	(249, 'NE404084', '2004-09-04', 48298.99, 'paid'),
	(250, 'EQ12267', '2005-05-17', 17928.09, 'paid'),
	(250, 'HD284647', '2004-12-30', 26311.63, 'paid'),
	(250, 'HN114306', '2003-07-18', 23419.47, 'paid'),
	(256, 'EP227123', '2004-02-10', 5759.42, 'paid'),
	(256, 'HE84936', '2004-10-22', 53116.99, 'paid'),
	(259, 'EU280955', '2004-11-06', 61234.67, 'paid'),
	(259, 'GB361972', '2003-12-07', 27988.47, 'paid'),
	(260, 'IO164641', '2004-08-30', 37527.58, 'paid'),
	(260, 'NH776924', '2004-04-24', 29284.42, 'paid'),
	(276, 'EM979878', '2005-02-09', 27083.78, 'paid'),
	(276, 'KM841847', '2003-11-13', 38547.19, 'paid'),
	(276, 'LE432182', '2003-09-28', 41554.73, 'paid'),
	(276, 'OJ819725', '2005-04-30', 29848.52, 'paid'),
	(278, 'BJ483870', '2004-12-05', 37654.09, 'paid'),
	(278, 'GP636783', '2003-03-02', 52151.81, 'paid'),
	(278, 'NI983021', '2003-11-24', 37723.79, 'paid'),
	(282, 'IA793562', '2003-08-03', 24013.52, 'paid'),
	(282, 'JT819493', '2004-08-02', 35806.73, 'paid'),
	(282, 'OD327378', '2005-01-03', 31835.36, 'paid'),
	(286, 'DR578578', '2004-10-28', 47411.33, 'pending'),
	(286, 'KH910279', '2004-09-05', 43134.04, 'pending'),
	(298, 'AJ574927', '2004-03-13', 47375.92, 'paid'),
	(298, 'LF501133', '2004-09-18', 61402.00, 'paid'),
	(299, 'AD304085', '2003-10-24', 36798.88, 'paid'),
	(299, 'NR157385', '2004-09-05', 32260.16, 'paid'),
	(311, 'DG336041', '2005-02-15', 46770.52, 'paid'),
	(311, 'FA728475', '2003-10-06', 32723.04, 'paid'),
	(311, 'NQ966143', '2004-04-25', 16212.59, 'paid'),
	(314, 'LQ244073', '2004-08-09', 45352.47, 'paid'),
	(314, 'MD809704', '2004-03-03', 16901.38, 'paid'),
	(319, 'HL685576', '2004-11-06', 42339.76, 'pending'),
	(319, 'OM548174', '2003-12-07', 36092.40, 'pending'),
	(320, 'GJ597719', '2005-01-18', 8307.28, 'pending'),
	(320, 'HO576374', '2003-08-20', 41016.75, 'pending'),
	(320, 'MU817160', '2003-11-24', 52548.49, 'pending'),
	(321, 'DJ15149', '2003-11-03', 85559.12, 'pending'),
	(321, 'LA556321', '2005-03-15', 46781.66, 'pending'),
	(323, 'AL493079', '2005-05-23', 75020.13, 'paid'),
	(323, 'ES347491', '2004-06-24', 37281.36, 'paid'),
	(323, 'HG738664', '2003-07-05', 2880.00, 'paid'),
	(323, 'PQ803830', '2004-12-24', 39440.59, 'paid'),
	(324, 'DQ409197', '2004-12-13', 13671.82, 'paid'),
	(324, 'FP443161', '2003-07-07', 29429.14, 'paid'),
	(324, 'HB150714', '2003-11-23', 37455.77, 'paid'),
	(328, 'EN930356', '2004-04-16', 7178.66, 'pending'),
	(328, 'NR631421', '2004-05-30', 31102.85, 'pending'),
	(333, 'HL209210', '2003-11-15', 23936.53, 'paid'),
	(333, 'JK479662', '2003-10-17', 9821.32, 'paid'),
	(333, 'NF959653', '2005-03-01', 21432.31, 'paid'),
	(334, 'CS435306', '2005-01-27', 45785.34, 'paid'),
	(334, 'HH517378', '2003-08-16', 29716.86, 'paid'),
	(334, 'LF737277', '2004-05-22', 28394.54, 'paid'),
	(339, 'AP286625', '2004-10-24', 23333.06, 'pending'),
	(339, 'DA98827', '2003-11-28', 34606.28, 'pending'),
	(344, 'AF246722', '2003-11-24', 31428.21, 'paid'),
	(344, 'NJ906924', '2004-04-02', 15322.93, 'paid'),
	(347, 'DG700707', '2004-01-18', 21053.69, 'pending'),
	(347, 'LG808674', '2003-10-24', 20452.50, 'pending'),
	(350, 'BQ602907', '2004-12-11', 18888.31, 'paid'),
	(350, 'CI471510', '2003-05-25', 50824.66, 'paid'),
	(350, 'OB648482', '2005-01-29', 1834.56, 'paid'),
	(353, 'CO351193', '2005-01-10', 49705.52, 'paid'),
	(353, 'ED878227', '2003-07-21', 13920.26, 'paid'),
	(353, 'GT878649', '2003-05-21', 16700.47, 'paid'),
	(353, 'HJ618252', '2005-06-09', 46656.94, 'paid'),
	(357, 'AG240323', '2003-12-16', 20220.04, 'paid'),
	(357, 'NB291497', '2004-05-15', 36442.34, 'paid'),
	(362, 'FP170292', '2004-07-11', 18473.71, 'pending'),
	(362, 'OG208861', '2004-09-21', 15059.76, 'pending'),
	(363, 'HL575273', '2004-11-17', 50799.69, 'pending'),
	(363, 'IS232033', '2003-01-16', 10223.83, 'pending'),
	(363, 'PN238558', '2003-12-05', 55425.77, 'pending'),
	(379, 'CA762595', '2005-02-12', 28322.83, 'pending'),
	(379, 'FR499138', '2003-09-16', 32680.31, 'pending'),
	(379, 'GB890854', '2004-08-02', 12530.51, 'pending'),
	(381, 'BC726082', '2004-12-03', 12081.52, 'paid'),
	(381, 'CC475233', '2003-04-19', 1627.56, 'paid'),
	(381, 'GB117430', '2005-02-03', 14379.90, 'paid'),
	(381, 'MS154481', '2003-08-22', 1128.20, 'paid'),
	(382, 'CC871084', '2003-05-12', 35826.33, 'paid'),
	(382, 'CT821147', '2004-08-01', 6419.84, 'paid'),
	(382, 'PH29054', '2004-11-27', 42813.83, 'paid'),
	(385, 'BN347084', '2003-12-02', 20644.24, 'paid'),
	(385, 'CP804873', '2004-11-19', 15822.84, 'paid'),
	(385, 'EK785462', '2003-03-09', 51001.22, 'paid'),
	(386, 'DO106109', '2003-11-18', 38524.29, 'paid'),
	(386, 'HG438769', '2004-07-18', 51619.02, 'paid'),
	(398, 'AJ478695', '2005-02-14', 33967.73, 'pending'),
	(398, 'DO787644', '2004-06-21', 22037.91, 'pending'),
	(398, 'JPMR4544', '2005-05-18', 615.45, 'pending'),
	(398, 'KB54275', '2004-11-29', 48927.64, 'pending'),
	(406, 'BJMPR4545', '2005-04-23', 12190.85, 'paid'),
	(406, 'HJ217687', '2004-01-28', 49165.16, 'paid'),
	(406, 'NA197101', '2004-06-17', 25080.96, 'paid'),
	(412, 'GH197075', '2004-07-25', 35034.57, 'paid'),
	(412, 'PJ434867', '2004-04-14', 31670.37, 'paid'),
	(415, 'ER54537', '2004-09-28', 31310.09, 'paid'),
	(424, 'KF480160', '2004-12-07', 25505.98, 'pending'),
	(424, 'LM271923', '2003-04-16', 21665.98, 'pending'),
	(424, 'OA595449', '2003-10-31', 22042.37, 'pending'),
	(447, 'AO757239', '2003-09-15', 6631.36, 'pending'),
	(447, 'ER615123', '2003-06-25', 17032.29, 'pending'),
	(447, 'OU516561', '2004-12-17', 26304.13, 'pending'),
	(448, 'FS299615', '2005-04-18', 27966.54, 'paid'),
	(448, 'KR822727', '2004-09-30', 48809.90, 'paid'),
	(450, 'EF485824', '2004-06-21', 59551.38, 'pending'),
	(452, 'ED473873', '2003-11-15', 27121.90, 'paid'),
	(452, 'FN640986', '2003-11-20', 15130.97, 'paid'),
	(452, 'HG635467', '2005-05-03', 8807.12, 'paid'),
	(455, 'HA777606', '2003-12-05', 38139.18, 'pending'),
	(455, 'IR662429', '2004-05-12', 32239.47, 'pending'),
	(456, 'GJ715659', '2004-11-13', 27550.51, 'pending'),
	(456, 'MO743231', '2004-04-30', 1679.92, 'pending'),
	(458, 'DD995006', '2004-11-15', 33145.56, 'paid'),
	(458, 'NA377824', '2004-02-06', 22162.61, 'paid'),
	(458, 'OO606861', '2003-06-13', 57131.92, 'paid'),
	(462, 'ED203908', '2005-04-15', 30293.77, 'pending'),
	(462, 'GC60330', '2003-11-08', 9977.85, 'pending'),
	(462, 'PE176846', '2004-11-27', 48355.87, 'pending'),
	(471, 'AB661578', '2004-07-28', 9415.13, 'paid'),
	(471, 'CO645196', '2003-12-10', 35505.63, 'paid'),
	(473, 'LL427009', '2004-02-17', 7612.06, 'paid'),
	(473, 'PC688499', '2003-10-27', 17746.26, 'paid'),
	(475, 'DR343', '2021-05-27', 5632.00, 'pending'),
	(475, 'JP113227', '2003-12-09', 7678.25, 'pending'),
	(475, 'PB951268', '2004-02-13', 36070.47, 'pending'),
	(484, 'GK294076', '2004-10-26', 3474.66, 'paid'),
	(484, 'JH546765', '2003-11-29', 47513.19, 'paid'),
	(486, 'BL66528', '2004-04-14', 5899.38, 'pending'),
	(486, 'HS86661', '2004-11-23', 45994.07, 'pending'),
	(486, 'JB117768', '2003-03-20', 25833.14, 'pending'),
	(487, 'AH612904', '2003-09-28', 29997.09, 'pending'),
	(487, 'PT550181', '2004-02-29', 12573.28, 'pending'),
	(489, 'OC773849', '2003-12-04', 22275.73, 'paid'),
	(489, 'PO860906', '2004-01-31', 7310.42, 'paid'),
	(495, 'BH167026', '2003-12-26', 59265.14, 'pending'),
	(495, 'FN155234', '2004-05-14', 6276.60, 'pending'),
	(495, 'QQ27862', '2017-12-13', 3426.26, 'pending'),
	(496, 'EU531600', '2005-05-25', 30253.75, 'paid'),
	(496, 'MB342426', '2003-07-16', 32077.44, 'paid'),
	(496, 'MN89921', '2004-12-31', 52166.00, 'paid'),
	(496, 'XL55793', '2017-12-13', 1258.16, 'paid');
...
-- Dumping structure for table classicmodels.registration
CREATE TABLE IF NOT EXISTS `registration` (
  `id` int(11) NOT NULL,
  `first` varchar(255) DEFAULT NULL,
  `last` varchar(255) DEFAULT NULL,
  `age` int(11) DEFAULT NULL,
  `DemoDate` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table classicmodels.registration: ~0 rows (approximately)
/*!40000 ALTER TABLE `registration` DISABLE KEYS */;
INSERT INTO `registration` (`id`, `first`, `last`, `age`, `DemoDate`) VALUES
	(1, NULL, NULL, NULL, 'May - 25 - 2021 - Tuesday');
/*!40000 ALTER TABLE `registration` ENABLE KEYS */;

-- Dumping structure for table classicmodels.staff
CREATE TABLE IF NOT EXISTS `staff` (
  `sid` int(11) NOT NULL AUTO_INCREMENT,
  `sname` varchar(20) DEFAULT 'none',
  `areaexpertise` varchar(50) DEFAULT NULL,
  `type` varchar(10) DEFAULT NULL,
  `qualification` varchar(50) DEFAULT NULL,
  `subjectexpertise` varchar(50) DEFAULT NULL,
  `did` int(11) DEFAULT NULL,
  PRIMARY KEY (`sid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=latin1;

-- Dumping data for table classicmodels.staff: ~19 rows (approximately)
/*!40000 ALTER TABLE `staff` DISABLE KEYS */;
INSERT INTO `staff` (`sid`, `sname`, `areaexpertise`, `type`, `qualification`, `subjectexpertise`, `did`) VALUES
	(1, 'Alex', NULL, 'TS', 'MSc MEd', 'Maths', NULL),
	(2, 'Peterson', NULL, 'TS', 'BSc BEd', 'English', NULL),
	(3, 'Ramon', 'Accounts', 'NS', NULL, NULL, NULL),
	(4, 'Ali', 'Office Admin', 'NS', NULL, NULL, NULL),
	(7, 'Alex', NULL, 'TS', NULL, NULL, NULL),
	(8, 'Peterson', NULL, 'TS', NULL, NULL, NULL),
	(9, 'Ramon', NULL, 'NS', NULL, NULL, NULL),
	(10, 'Ali', NULL, 'NS', NULL, NULL, NULL),
	(11, 'Alex', NULL, 'TS', NULL, NULL, NULL),
	(12, 'Peterson', NULL, 'TS', NULL, NULL, NULL),
	(13, 'Ramon', NULL, 'NS', NULL, NULL, NULL),
	(14, 'Ali', NULL, 'NS', NULL, NULL, NULL),
	(15, 'Alex', NULL, 'TS', 'MSc MEd', 'Maths', NULL),
	(16, 'Peterson', NULL, 'TS', 'BSc BEd', 'English', NULL),
	(17, 'Ramon', 'Accounts', 'NS', NULL, NULL, NULL),
	(18, 'Ali', 'Office Admin', 'NS', NULL, NULL, NULL),
	(19, 'Alex', NULL, 'TS', NULL, NULL, NULL),
	(20, 'Peterson', NULL, 'TS', NULL, NULL, NULL),
	(21, 'Ramon', NULL, 'NS', NULL, NULL, NULL),
	(22, 'Ali', NULL, 'NS', NULL, NULL, NULL);
