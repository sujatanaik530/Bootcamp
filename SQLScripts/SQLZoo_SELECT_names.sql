...
-- 8 India and Angola have an n as the second character. You can use the underscore 
...
-- 12 The capital of Mexico is Mexico City. Show all the countries where the capital has the 
